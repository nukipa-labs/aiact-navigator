...
const EMAIL_COPY = {
  heading: 'Email me my result and the free AI Act Checklist',
  subcopy:
    "We'll send this steer plus our plain-English AI Act Checklist, and keep you posted as the rules move. Unsubscribe in one click.",
  placeholder: 'you@company.com',
  button: 'Send me my result',
  microtrust: 'No spam. Unsubscribe anytime.',
  success: "On its way. Check your inbox for your result and the AI Act Checklist.",
...
// Progress route line: completed = indigo, current = amber, upcoming = hollow.
...
export function RiskClassifier() {
  ...
  const [history, setHistory] = useState<QuestionId[]>(['eu-nexus']);
  ...
  const slideClass =
    direction === 1 ? 'sc-enter-right' : 'sc-enter-left';
...
function ResultView({
  ...
  return (
    <div className={slideClass}>
      ...
      >
        {/* Verdict, TL;DR-style box (low tint, 3px left accent). */}
      ...
      <div className="mt-6 flex flex-wrap gap-2">
        ...
        <CrossLink href="/obligations" label="Obligations checker" />
      ...
      <p className="mt-6 text-sm text-muted leading-relaxed">
        This is guidance to help you orient, not a legal determination. Confirm against the
...
// The result-emailing capture. POSTs to /api/lead with slug 'risk-classifier'.
