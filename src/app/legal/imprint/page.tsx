    ...
    <Container size="md" className="py-16 lg:py-24">
      ...
      <div className="mt-8">
        <Prose>
          ...
          <p>
            AI Act Navigator (aiact-navigator.com) is a free information service operated by
            Nukipa Labs GmbH. The information provided is general guidance on the EU AI Act
            (Regulation (EU) 2024/1689) and is not legal advice.
          </p>
        </Prose>
      </div>
    </Container>
