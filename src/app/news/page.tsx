...
export const metadata: Metadata = {
  title:       'The AI Act Brief: EU AI Act news & regulatory updates',
  description:
    "The archive of EU AI Act news and regulatory updates. We watch Brussels so you don't: plain-English summaries of what changed, what it means, and what to do next."
};
      ...
      <Container>
        <header className="mb-12 max-w-2xl">
          ...
          <h1 className="font-display text-4xl font-semibold tracking-[-0.01em] text-ink lg:text-5xl">
            EU AI Act news &amp; regulatory updates
          </h1>
          <p className="mt-4 font-body text-base leading-relaxed text-[color:var(--color-text-muted)] lg:text-lg">
            The EU AI Act keeps moving. This is the archive of what changed, in plain
        ...
        {posts.length === 0 ? (
          <div className="rounded-card border border-line bg-card p-8 lg:p-10">
            <p className="font-body text-base leading-relaxed text-[color:var(--color-text-muted)]">
              The first briefings are coming soon. Subscribe to The AI Act Brief to
              get them.
            </p>
            <Link
              href="/subscribe"
